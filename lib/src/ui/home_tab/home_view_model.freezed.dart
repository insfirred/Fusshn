...
abstract class $HomeViewStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<EventData> events, HomeViewStatus status, String? errorMessage});
}
...
class _$HomeViewStateImpl implements _HomeViewState {
  ...
  @override
  String toString() {
    return 'HomeViewState(events: $events, status: $status, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_events), status, errorMessage);
